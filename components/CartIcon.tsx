...
export default function CartIcon({ onClick }: CartIconProps) {
  ...
  return (
    <button
      onClick={onClick}
      className="fixed top-6 right-20 flex items-center justify-center w-12 h-12 bg-squarage-green group z-[9999] hover:scale-110 transition-all duration-300 drop-shadow-lg"
