  ...
  return (
    <section className="pb-4 sm:pb-8 md:pb-12">
      ...
      <div className="grid grid-cols-1 gap-0">
        ...
        >
          <div className="p-4 sm:p-8 md:p-12 lg:p-16 transition-colors duration-500 bg-squarage-blue hover:bg-squarage-yellow">
            <div className="bg-squarage-white px-6 py-4 sm:px-8 sm:py-6 md:px-12 md:py-8 text-center flex items-center justify-center border-4 md:border-0 border-squarage-black">
        ...
        {isTouchDevice && (
          <div className="px-4 pb-4 pt-1 sm:px-8 sm:pb-8 sm:pt-2 md:px-12 md:pb-12 md:pt-3 lg:px-16 lg:pb-16 lg:pt-4 bg-squarage-blue">
            <div className="flex justify-center">
              <Link
                href="/custom-projects"
                className="px-6 py-3 bg-squarage-white border-4 border-squarage-black font-bold font-neue-haas text-squarage-black text-xl hover:bg-squarage-yellow transition-colors duration-300"
              >
                Start designing
              </Link>
            </div>
