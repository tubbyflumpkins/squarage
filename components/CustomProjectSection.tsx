        ...
        {isTouchDevice && (
          <div className="px-4 pb-4 pt-1 sm:px-8 sm:pb-8 sm:pt-2 md:px-12 md:pb-12 md:pt-3 lg:px-16 lg:pb-16 lg:pt-4 bg-squarage-blue">
            <div className="flex justify-center">
              <Link
                href="/custom-projects"
                className="px-6 py-3 bg-squarage-white border-2 border-squarage-black font-bold font-neue-haas text-squarage-black text-xl hover:bg-squarage-yellow transition-colors duration-300"
              >
                Start designing
              </Link>
            </div>
