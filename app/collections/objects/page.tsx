...
export const metadata: Metadata = {
  title: 'Objects Collection - Coming Soon | Squarage Studio',
  description: 'Our unique decorative and functional objects collection is coming soon. Stay tuned for distinctive pieces that complement any space.',
  keywords: ['objects', 'decorative', 'functional', 'handcrafted furniture', 'Los Angeles', 'Squarage Studio', 'coming soon'],
  openGraph: {
    title: 'Objects Collection - Coming Soon | Squarage Studio',
    description: 'Unique decorative and functional objects coming soon.',
    type: 'website',
  },
}
